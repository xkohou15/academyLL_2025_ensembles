...
import openfold.openfold.data.data_transforms as data_transforms
from openfold.openfold.np.residue_constants import (
    restype_rigid_group_default_frame,
    restype_atom14_to_rigid_group,
    restype_atom14_mask,
    restype_atom14_rigid_group_positions,
)
import openfold.openfold.utils.feats as feats
from openfold.openfold.utils.rigid_utils import Rotation, Rigid
from openfold.openfold.utils.geometry.rigid_matrix_vector import Rigid3Array
from openfold.openfold.utils.geometry.rotation_matrix import Rot3Array
from openfold.openfold.utils.geometry.vector import Vec3Array
from openfold.openfold.utils.tensor_utils import (
    tree_map,
    tensor_tree_map,
)
import openfold.tests.compare_utils as compare_utils
from openfold.tests.config import consts
from openfold.tests.data_utils import random_affines_4x4, random_asym_ids
